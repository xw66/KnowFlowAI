...
export interface KnowledgeBase { id: number; name: string; ownerId: number; role: 'OWNER' | 'EDITOR' | 'VIEWER' }
...
export const roleName = (role: string) => ({ OWNER: '所有者', EDITOR: '可编辑', VIEWER: '只读' }[role] ?? role)
